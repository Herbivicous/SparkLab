...
one_machine_jobs = nb_of_jobs_per_nb_of_machines.collectAsMap()[1]
...
disk = usage_over_requested.map(
	lambda task: (
		task[TASK][REQUEST][DISK],
		task[TASK][USAGE][DISK]
	)
)
